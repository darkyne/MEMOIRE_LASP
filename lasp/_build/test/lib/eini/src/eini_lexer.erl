...
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 58).
...
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.erl", 307).
yystate() -> 7.
...
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 44 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(10, Ics, Line, Tlen+1, 6, Tlen);
yystate(10, [C|Ics], Line, Tlen, _, _) when C >= 62, C =< 64 ->
    yystate(9, Ics, Line, Tlen+1, 6, Tlen);
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Tlen+1, 7, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 33, C =< 58 ->
    yystate(9, Ics, Line, Tlen+1, 7, Tlen);
...
yystate(8, Ics, Line, Tlen, _, _) ->
    {8,Tlen,Ics,Line,8};
yystate(7, [96|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, [60|Ics], Line, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [59|Ics], Line, Tlen, Action, Alen) ->
...
yystate(7, [9|Ics], Line, Tlen, Action, Alen) ->
    yystate(5, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 33, C =< 44 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 62, C =< 64 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 65, C =< 90 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 97, C =< 122 ->
    yystate(10, Ics, Line, Tlen+1, Action, Alen);
yystate(7, [C|Ics], Line, Tlen, Action, Alen) when C >= 123 ->
    yystate(9, Ics, Line, Tlen+1, Action, Alen);
...
yystate(2, [10|Ics], Line, Tlen, _, _) ->
    yystate(2, Ics, Line+1, Tlen+1, 0, Tlen);
...
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 38).
yyaction_0(TokenLine) ->
     { token, { break, TokenLine } } .

-compile({inline,yyaction_1/1}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 41).
yyaction_1(TokenLine) ->
     { token, { break, TokenLine } } .

-compile({inline,yyaction_2/1}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 44).
yyaction_2(TokenLine) ->
     { token, { '=', TokenLine } } .

-compile({inline,yyaction_3/1}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 45).
yyaction_3(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_4/1}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 46).
yyaction_4(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_5/2}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 49).
yyaction_5(TokenChars, TokenLine) ->
     { token, { blank, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/2}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 50).
yyaction_6(TokenChars, TokenLine) ->
     { token, { word, TokenLine, TokenChars } } .

-compile({inline,yyaction_7/2}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 51).
yyaction_7(TokenChars, TokenLine) ->
     { token, { value, TokenLine, TokenChars } } .

-compile({inline,yyaction_8/2}).
-file("/home/gcreupelandt/Documents/MEMOIRE/lasp/_build/test/lib/eini/src/eini_lexer.xrl", 54).
yyaction_8(TokenChars, TokenLine) ->
